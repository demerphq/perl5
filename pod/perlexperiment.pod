...
C<gen> and C<yield> keywords provide cooperative,
one-shot resumable execution.  The C<generator> pragma enables the generator
and signatures features and provides the related generator package methods
and functions.

See L<perlgenerator> and L<perlfunc/gen BLOCK>.
