...
Using this feature requires C<use feature 'generator'>.  The
C<generator_create> and C<generator_yield> keywords provide cooperative,
one-shot resumable execution.  The C<generator> pragma enables the feature
and imports the related generator predicate builtins.

See L<perlgenerator> and L<perlfunc/generator_create BLOCK>.
