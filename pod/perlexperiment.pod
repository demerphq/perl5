...
Using this feature requires C<use feature 'iterator'>.  The
C<iterator_create>, C<iterator_yield>, and C<iterator_exhausted> keywords
provide cooperative, one-shot resumable execution.

See L<perlasync> and L<perlfunc/iterator_create BLOCK>.
