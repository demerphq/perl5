...
Using this feature requires C<use feature 'generator'>.  The C<generator>
and C<yield> keywords provide cooperative, one-shot resumable execution.

See L<perlasync> and L<perlfunc/generator BLOCK>.
