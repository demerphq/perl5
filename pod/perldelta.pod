...
The experimental C<dispatch> feature adds a C<dispatch> statement with ordered
...
L<perlsyn/Experimental Data-Shape Matching> for the current experimental design
and limitations.
