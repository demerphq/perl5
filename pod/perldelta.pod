...
from a block.  Each call resumes the block until its next C<yield>, returning
one value, and returns an empty list after the block has finished.  See
L<perlfunc/generator BLOCK> for details.
