...
an uncaught exception escaping its body marks it failed before the exception
is rethrown.  Generators inherit this protocol while continuing to manage
their continuation state internally.  See L<perlgenerator/CALLABLE ITERATORS>.
