...
=head2 Reference Manual
    ...
    perlcasematch       Experimental case and data-shape matching syntax
    perlnamespace       Perl lexical namespaces and package aliases
    perldata            Perl data structures
    perlop              Perl expressions: operators, precedence, string literals
    perlsub             Perl subroutines
    perlfunc            Perl built-in functions
    perliterator        Callable iterators and their lifecycle
    perlgenerator       Generators and cooperative resumable execution
...
=head2 History
    ...
    perl5423delta       Perl changes in version 5.42.3
    ...
    perl5405delta       Perl changes in version 5.40.5
