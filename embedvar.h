...
# define PL_comppad                             (vTHX->Iexecution_context->Icomppad)
...
# define PL_curcop                              (vTHX->Iexecution_context->Icurcop)
# define PL_curcopdb                            (vTHX->Iexecution_context->Icurcopdb)
# define PL_curlocales                          (vTHX->Icurlocales)
# define PL_curpad                              (vTHX->Iexecution_context->Icurpad)
# define PL_curpm                               (vTHX->Iexecution_context->Icurpm)
# define PL_curpm_under                         (vTHX->Iexecution_context->Icurpm_under)
# define PL_curstack                            (vTHX->Iexecution_context->Icurstack)
# define PL_curstackinfo                        (vTHX->Iexecution_context->Icurstackinfo)
# define PL_curstash                            (vTHX->Iexecution_context->Icurstash)
...
# define PL_defgv                               (vTHX->Iexecution_context->Idefgv)
# define PL_defoutgv                            (vTHX->Idefoutgv)
# define PL_defstash                            (vTHX->Idefstash)
# define PL_delaymagic                          (vTHX->Iexecution_context->Idelaymagic)
...
# define PL_dowarn                              (vTHX->Iexecution_context->Idowarn)
...
# define PL_env_mutex_readers                   (vTHX->Ienv_mutex_readers)
...
# define PL_execution_context                   (vTHX->Iexecution_context)
# define PL_execution_context_storage           (vTHX->Iexecution_context_storage)
...
# define PL_in_eval                             (vTHX->Iexecution_context->Iin_eval)
...
# define PL_in_warnhook                         (vTHX->Iin_warnhook)
...
# define PL_localizing                          (vTHX->Iexecution_context->Ilocalizing)
...
# define PL_markstack                           (vTHX->Iexecution_context->Imarkstack)
# define PL_markstack_max                       (vTHX->Iexecution_context->Imarkstack_max)
# define PL_markstack_ptr                       (vTHX->Iexecution_context->Imarkstack_ptr)
...
# define PL_multideref_pc                       (vTHX->Iexecution_context->Imultideref_pc)
...
# define PL_op                                  (vTHX->Iexecution_context->Iop)
...
# define PL_runops_boundary_data                (vTHX->Irunops_boundary_data)
# define PL_runops_boundary_hook                (vTHX->Irunops_boundary_hook)
# define PL_savebegin                           (vTHX->Isavebegin)
# define PL_savestack                           (vTHX->Iexecution_context->Isavestack)
# define PL_savestack_ix                        (vTHX->Iexecution_context->Isavestack_ix)
# define PL_savestack_max                       (vTHX->Iexecution_context->Isavestack_max)
# define PL_SB_invlist                          (vTHX->ISB_invlist)
# define PL_scopestack                          (vTHX->Iexecution_context->Iscopestack)
# define PL_scopestack_ix                       (vTHX->Iexecution_context->Iscopestack_ix)
# define PL_scopestack_max                      (vTHX->Iexecution_context->Iscopestack_max)
...
# define PL_stack_base                          (vTHX->Iexecution_context->Istack_base)
# define PL_stack_max                           (vTHX->Iexecution_context->Istack_max)
# define PL_stack_sp                            (vTHX->Iexecution_context->Istack_sp)
...
# define PL_tainted                             (vTHX->Iexecution_context->Itainted)
# define PL_tainting                            (vTHX->Iexecution_context->Itainting)
# define PL_threadhook                          (vTHX->Ithreadhook)
# define PL_tmps_floor                          (vTHX->Iexecution_context->Itmps_floor)
# define PL_tmps_ix                             (vTHX->Iexecution_context->Itmps_ix)
# define PL_tmps_max                            (vTHX->Iexecution_context->Itmps_max)
# define PL_tmps_stack                          (vTHX->Iexecution_context->Itmps_stack)
...
# define PL_veto_switch_non_tTHX_context        (vTHX->Iveto_switch_non_tTHX_context)
...
# define PL_comppad                             (PL_execution_context->Icomppad)
# define PL_curcop                              (PL_execution_context->Icurcop)
# define PL_curcopdb                            (PL_execution_context->Icurcopdb)
# define PL_curpad                              (PL_execution_context->Icurpad)
# define PL_curpm                               (PL_execution_context->Icurpm)
# define PL_curpm_under                         (PL_execution_context->Icurpm_under)
# define PL_curstack                            (PL_execution_context->Icurstack)
# define PL_curstackinfo                        (PL_execution_context->Icurstackinfo)
# define PL_curstash                            (PL_execution_context->Icurstash)
# define PL_defgv                               (PL_execution_context->Idefgv)
# define PL_delaymagic                          (PL_execution_context->Idelaymagic)
# define PL_dowarn                              (PL_execution_context->Idowarn)
# define PL_in_eval                             (PL_execution_context->Iin_eval)
# define PL_localizing                          (PL_execution_context->Ilocalizing)
# define PL_markstack                           (PL_execution_context->Imarkstack)
# define PL_markstack_max                       (PL_execution_context->Imarkstack_max)
# define PL_markstack_ptr                       (PL_execution_context->Imarkstack_ptr)
# define PL_multideref_pc                       (PL_execution_context->Imultideref_pc)
# define PL_op                                  (PL_execution_context->Iop)
# define PL_restartop                           (PL_execution_context->Irestartop)
# define PL_savestack                           (PL_execution_context->Isavestack)
# define PL_savestack_ix                        (PL_execution_context->Isavestack_ix)
# define PL_savestack_max                       (PL_execution_context->Isavestack_max)
# define PL_scopestack                          (PL_execution_context->Iscopestack)
# define PL_scopestack_ix                       (PL_execution_context->Iscopestack_ix)
# define PL_scopestack_max                      (PL_execution_context->Iscopestack_max)
# define PL_stack_base                          (PL_execution_context->Istack_base)
# define PL_stack_max                           (PL_execution_context->Istack_max)
# define PL_stack_sp                            (PL_execution_context->Istack_sp)
# define PL_tainted                             (PL_execution_context->Itainted)
# define PL_tainting                            (PL_execution_context->Itainting)
# define PL_tmps_floor                          (PL_execution_context->Itmps_floor)
# define PL_tmps_ix                             (PL_execution_context->Itmps_ix)
# define PL_tmps_max                            (PL_execution_context->Itmps_max)
# define PL_tmps_stack                          (PL_execution_context->Itmps_stack)
