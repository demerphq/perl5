...
INIT({
	...
	Perl_pp_entergiven,
	Perl_pp_leavegiven,
	Perl_pp_enterdispatch,
	Perl_pp_leavedispatch,
	Perl_pp_enteron,
	Perl_pp_leaveon,
	Perl_pp_enterwhen,
	Perl_pp_leavewhen,
...
INIT({
	...
	Perl_ck_null,		/* enterdispatch */
	Perl_ck_null,		/* leavedispatch */
	Perl_ck_null,		/* enteron */
	Perl_ck_null,		/* leaveon */
...
/* Indexes into PL_check for the comparison function pointers */
  ...
  #define PERL_CK_NULL  446
  #define PERL_CK_EXISTS  447
  #define PERL_CK_DELETE  448
#endif
...
EXTCONST U32 PL_opargs[] INIT({
	...
	0x00000340,	/* enterdispatch */
	0x00000100,	/* leavedispatch */
	0x00000340,	/* enteron */
	0x00000100,	/* leaveon */
...
EXTCONST I16 PL_op_private_bitfields[] INIT( {
    0, 8, -1,
    0, 8, -1,
    0, 876, 1, 642, 2, 86, 3, 330, -1,
    0, 927, -1,
    0, 8, -1,
    0, 8, -1,
    0, -1, 1, 36, 2, 344, 3, 101, 4, 704, 5, 765, 6, 325, 7, 722, 8, 635, 9, 550, 10, 490, 11, 279, 12, 906, 13, 482, 14, 758, 15, 914, -1,
    0, 934, -1,
    0, 923, -1,
...
EXTCONST U16  PL_op_private_bitdefs[] INIT( {
    ...
    0x491c, 0x0218, 0x62d4, 0x030f, /* ref_cmp */
    ...
    0x3e5d, /* match */
    0x08b5, /* subst */
    0x151c, 0x6fb8, 0x0d54, 0x660c, 0x2f08, 0x00c7, /* trans, transr */
    0x135c, 0x07d8, 0x0067, /* sassign */
    0x1018, 0x0f14, 0x0e10, 0x47ac, 0x08a8, 0x0067, /* aassign */
    0x6bf0, 0x0003, /* chomp, schomp, negate, i_negate, scomplement, sin, cos, exp, log, sqrt, int, hex, oct, abs, ord, chr, chroot, rmdir */
    0x46bc, 0x66f8, 0x3fb4, 0x6bf0, 0x0003, /* undef */
    0x08b4, 0x47ac, 0x0003, /* pos */
    0x6bf0, 0x0067, /* pow, multiply, i_multiply, divide, i_divide, modulo, i_modulo, add, i_add, subtract, i_subtract */
    0x18d8, 0x0067, /* repeat */
    0x569c, 0x49f8, 0x6bf0, 0x0067, /* concat */
    0x46bc, 0x03b8, 0x20b4, 0x6bf0, 0x692c, 0x0003, /* multiconcat */
    0x6bf0, 0x02af, /* stringify, atan2, rand, srand, crypt, push, unshift, flock, chown, unlink, chmod, utime, rename, link, symlink, mkdir, waitpid, system, exec, kill, getpgrp, setpgrp, getpriority, setpriority, sleep */
    0x6bf0, 0x6ec9, /* left_shift, right_shift, nbit_and, nbit_xor, nbit_or, ncomplement */
    0x6ec9, /* bit_and, bit_xor, bit_or, sbit_and, sbit_xor, sbit_or, complement */
    0x08b4, 0x6bf0, 0x0003, /* length */
    0x5c30, 0x47ac, 0x024b, /* substr */
    0x6bf0, 0x024b, /* substr_left */
    0x47ac, 0x0067, /* vec */
    ...
    0x6a78, 0x0003, /* exists */
    0x46bc, 0x52f8, 0x08b4, 0x0950, 0x47ac, 0x64c8, 0x6844, 0x40a1, /* rv2hv */
    0x46bc, 0x45b8, 0x1594, 0x1fd0, 0x47ac, 0x6844, 0x0003, /* multideref */
    0x46bc, 0x52f8, 0x0550, 0x424c, 0x3209, /* split */
    0x46bc, 0x2a19, /* list */
    0x46bc, 0x66f8, 0x0294, 0x6bf0, 0x02af, /* emptyavhv */
    0x1830, 0x3acc, 0x5d28, 0x3bc4, 0x4ee1, /* sort */
    ...
    0x00bc, 0x2c98, 0x0734, 0x2d50, 0x6a6c, 0x42c8, 0x2144, 0x5781, /* caller */
    0x2e15, /* nextstate, dbstate */
    0x447c, 0x59b9, /* leave */
    0x46bc, 0x52f8, 0x148c, 0x5da5, /* enteriter */
    0x588c, 0x3528, 0x5da5, /* iter */
    ...
    0x6bf1, /* wait, getppid, time */
    0x1ef8, 0x5b34, 0x1230, 0x0a0c, 0x6e48, 0x2ba4, 0x0003, /* entereval */
    ...
    0x363c, 0x6098, 0x0003, /* methstart */
...
EXTCONST U8 PL_op_private_valid[] INIT( {
    ...
    /* CONCAT     */ (OPpARG2_MASK|OPpTARGET_MY|OPpCONCAT_NESTED|OPpCONCAT_PATTERN),
    ...
    /* ENTERDISPATCH */ (OPpARG1_MASK),
    /* LEAVEDISPATCH */ (OPpARG1_MASK),
    /* ENTERON    */ (OPpARG1_MASK),
    /* LEAVEON    */ (OPpARG1_MASK),
