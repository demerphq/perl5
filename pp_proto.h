...
PERL_CALLCONV PP(pp_enterdispatch) __attribute__visibility__("hidden");
...
PERL_CALLCONV PP(pp_enteron) __attribute__visibility__("hidden");
...
PERL_CALLCONV PP(pp_leavedispatch) __attribute__visibility__("hidden");
...
PERL_CALLCONV PP(pp_leaveon) __attribute__visibility__("hidden");
